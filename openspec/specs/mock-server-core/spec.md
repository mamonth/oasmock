...
Core HTTP mock server that loads OpenAPI schemas, routes requests, selects examples based on conditions, evaluates runtime expressions, manages state, and generates responses.
