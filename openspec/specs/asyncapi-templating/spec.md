# asyncapi-templating Specification

## Purpose
Runtime-expression evaluation, x-mock-* example selection, state mutation and history recording for AsyncAPI message examples, identical to the OpenAPI pipeline.
## Requirements
