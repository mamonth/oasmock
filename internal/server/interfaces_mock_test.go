...
// Source: github.com/mamonth/oasmock/internal/server (interfaces: RouteProvider,StateStore,HistoryStore,DataSource,RequestSourceFactory,StateSourceFactory,EnvSourceFactory,ExpressionEvaluator,ExtensionProcessor,RpcProtocol)
...
func (m *MockRpcProtocol) ErrorResponse(arg0 int, arg1 string, arg2 interface{}) []byte {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ErrorResponse", arg0, arg1, arg2)
	ret0, _ := ret[0].([]byte)
	return ret0
}

// ErrorResponse indicates an expected call of ErrorResponse.
func (mr *MockRpcProtocolMockRecorder) ErrorResponse(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ErrorResponse", reflect.TypeOf((*MockRpcProtocol)(nil).ErrorResponse), arg0, arg1, arg2)
}

// ParseBody mocks base method.
func (m *MockRpcProtocol) ParseBody(arg0 []byte) ([]RpcCall, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseBody", arg0)
	ret0, _ := ret[0].([]RpcCall)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ParseBody indicates an expected call of ParseBody.
func (mr *MockRpcProtocolMockRecorder) ParseBody(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParseBody", reflect.TypeOf((*MockRpcProtocol)(nil).ParseBody), arg0)
}
